...
export default function SuperBuilderProfile() {
  ...
  return (
    <div className="max-w-4xl space-y-6 text-slate-800">
      <div className="border-b border-slate-700 pb-5">
        <h1 className="text-2xl font-extrabold text-slate-100 tracking-tight">Super Builder Profile</h1>
        <p className="text-slate-400 text-xs font-semibold mt-0.5">Your company details. Edit and save to update.</p>
      </div>
          ...
          <form onSubmit={handleSave} className="space-y-4 text-xs font-semibold text-slate-400">
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  className="w-full bg-slate-50 border border-slate-200 focus:border-purple-500 rounded-xl py-2.5 px-3 text-slate-800 outline-none text-sm font-medium transition focus:ring-1 focus:ring-purple-500"
                />
              </div>
              <div className="space-y-1.5">
            ...
            <div className="pt-2 flex justify-end">
              <button
                ...
                className={`px-5 py-2.5 font-bold rounded-xl shadow-md transition text-white ${hasChanges ? "bg-purple-600 hover:bg-purple-700" : "bg-slate-300 cursor-not-allowed"}`}
              >
        ...
        <div className="lg:col-span-5 space-y-6">
          <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm space-y-4">
            ...
            <div className="flex items-center space-x-3">
              <Building2 className="w-10 h-10 text-purple-500 shrink-0" />
              <div>
                <div className="text-base font-bold text-slate-900">{profile?.agency_name || "Super Builder"}</div>
                <div className="text-[10px] text-slate-500 font-semibold capitalize">Role: {profile?.role ? profile.role.replace('_', ' ') : ""}</div>
              </div>
            </div>
